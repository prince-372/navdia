                ...
                <div className='bg-[url(./assets/image/webp/hero-bg-img.webp)] bg-cover bg-center bg-no-repeat xl:min-h-[810px] min-h-screen relative mb-[25px] z-10 overflow-x-clip'>
                        ...
                        <div className='max-[1536px]:max-w-[1140px] container mx-auto px-3 pt-12 sm:pt-[83px]'>
                                <div className=' grid lg:grid-cols-2 gap-6 md:gap-[40px] '>
                                        <div>
                                                <img className='  pb-[21px] w-[100px] lg:w-[146px]' src={nvidIa} alt="nvdIa" width={146} height={146} />
                                                <h1 className=' text-white font-Inter font-bold xl:text-[52px] sm:text-[46px] text-[33px] xl:leading-[62px] sm:leading-[56px] leading-[43px] max-w-[499px] pb-4'>It’s the right time to buy Nvidia Stock</h1>
                                                ...
                                                <div className=' flex items-center gap-3 sm:gap-[15px]'>
                                                        <button className=' bg-white text-base flex justify-center items-center rounded-[58px] font-Inter font-semibold text-lightBlue duration-300 hover:text-white hover:bg-transparent border border-solid border-transparent hover:border hover:solid hover:border-white hover:scale-95 sm:w-[146px] w-[140px] h-[48px]'>Invest Now</button>
                                                        <button className=' bg-transparent text-base justify-center items-center flex rounded-[58px] font-Inter font-semibold text-white border border-s border-white duration-300 hover:bg-white hover:text-lightBlue hover:scale-95 sm:w-[149px] w-[140px] h-[48px]'>Know why?</button>
                                                </div>

                                        </div>
                                        <div className='bg-white rounded-[32px] flex flex-col ml-auto justify-center lg:justify-start mx-auto lg:mr-0 max-w-[337px] sm:max-w-[495px] lg:mt-[23px] mb-[23px] p-[32px] border border-solid border-skyDarkBlue shadow-[0_11px_33.5px_0_#0000001F;]'>
                                                ...
                                                <form onSubmit={handleSubmit}>
                                                        ...
                                                        <button type="submit" className=' hover:bg-CommonGradientH duration-300 bg-CommonGradient h-[51px] max-w-[429px] w-full rounded-[38px] font-Inter font-semibold text-base text-white'>Get Started</button>
                                                </form>
                                        </div>
                                </div>
                        </div>
