...
const Navsection = () => {
        ...
        return (
                <div className='bg-[url(./assets/image/png/hero-bg-img.png)] bg-cover bg-center bg-no-repeat xl:min-h-[810px] min-h-screen relative mb-[25px] z-10 overflow-x-clip'>
                        ...
                        <div className='container mx-auto px-3 pt-12 sm:pt-[83px]'>
                                <div className=' grid lg:grid-cols-2 gap-6 md:gap-[40px] lg:gap-[137px]'>
                                        ...
                                        <div className='bg-white rounded-[32px] flex flex-col justify-center lg:justify-start mx-auto lg:mx-0 w-[337px] sm:w-[493px] mt-[23px] p-[32px] border border-solid border-skyDarkBlue shadow-[0_11px_33.5px_0_#0000001F;]'>
                        ...
                        <img className='  absolute top-[12%] lg:top-[17%] left-0 -z-10' src={dashedElips} alt="dashedElips" />
                        <img className=' animate-pulse absolute top-[5%] lg:top-[7%] left-0 -z-10' src={circleElips} alt="circleElips" />
                        <img className=' absolute top-[8%] right-[-34%] sm:right-[5%] lg:right-[27%] -z-10' src={heroElips} alt="heroElips" />
                        <img className=' absolute top-[53%] right-[42%] -z-10' src={heroDashedElips} alt="heroDashedElips" />
                </div>
        )
}
