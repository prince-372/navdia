      ...
      <div className=' max-w-[1140px] container mx-auto px-3'>
        <div className=' grid lg:grid-cols-2 gap-[18px]'>
                <div className=' flex order-2 lg:order-1 justify-center flex-col'>
                        <h2 className=' font-Inter font-bold sm:text-[44px] text-[35px] leading-[46px] md:leading-[57px] text-center lg:text-start  text-black2  pb-3 md:pb-6'>Nvidia - AI GPU <span className=' lg:block'>1 year 228% Growth</span></h2>
