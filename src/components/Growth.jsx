      ...
      <div className=' container mx-auto px-3'>
        <div className=' grid lg:grid-cols-2 gap-[18px]'>
                <div className=' flex order-2 lg:order-1 justify-center flex-col'>
                        <h2 className=' font-Inter font-bold text-[44px] leading-[57px] text-black2  pb-6'>Nvidia - AI GPU <span className=' lg:block'>1 year 228% Growth</span></h2>
                ...
                <img className=' order-1 lg:order-2 duration-300 hover:shadow-[0_11px_26.7px_0_#0000001F] rounded-2xl' src={chartImg} alt="chartImg" width={631} height={344} />
        </div>
      </div>
