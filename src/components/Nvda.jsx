  ...
  return (
    <div  className=' relative xl:pt-[100px] lg:pt-[60px] pt-[17px] overflow-x-clip lg:pb-[125px] pb-[48px]'>
     ...
     <div className=' relative z-10 pt-4 lg:pt-0'>
        <p className=' font-Inter sm:text-[44px] text-[27px] sm:leading-[46px] leading-[33px] md:leading-[57px] font-bold max-w-[521px] text-black mx-auto lg:mx-0 text-center lg:text-start md:pt-[88px] sm:pt-[32px]'>3 Reasons to Buy Nvidia Stock with AI</p>
