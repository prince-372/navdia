  ...
  return (
    <div  className=' relative lg:pt-[100px] pt-[17px] overflow-x-clip lg:pb-[97px] pb-[48px]'>
     ...
     <div className=' relative z-10 pt-4 lg:pt-0'>
        <p className=' font-Inter sm:text-[44px] text-[34px] sm:leading-[57px] leading-[45px] font-bold max-w-[521px] text-black mx-auto lg:mx-0 text-center lg:text-start md:pt-[88px] pt-[32px]'>3 Reasons to Buy Nvidia Stock with AI</p>
