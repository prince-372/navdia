  ...
  return (
    <div  className=' relative pt-[100px] overflow-x'>
     ...
     <div className=' relative'>
        ...
        <div className=' flex justify-center mt-[-10%] sm:mt-0'><img className=' sm:absolute bottom-[5%] left-[54%] w-[219px] h-[94px]' src={smallCard} alt="smallCard" /></div>
     </div>
     <div className=' relative z-10'>
        ...
        <div className=' pt-[40px] flex justify-center lg:justify-start'>
            <Commanbtn className="w-[182px] h-[48px] mt-[40px]" text="Read full article"/>
        </div>
     </div>
          </div>
        </div>
