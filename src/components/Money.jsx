    ...
    <div className="xl:pt-[172px] lg:pt-[110px] pt-[68px] relative overflow-x max-lg:pb-[53px] pb-[10px]  overflow-x-clip z-10">
      ...
      <div className=" container px-3 mx-auto">
        ...
        <div className=" flex justify-center pt-12">
            <button className="text-base shadow-[0px_2px_10px_0px_#ECECEC] w-[147px] h-[48px] font-bold font-Inter py-3 px-[30px] rounded-[58px] bg-CommonGradient text-white hover:bg-CommonGradientH duration-300">Invest Now </button>
        </div>
      </div>
