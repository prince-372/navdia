        ...
        return (
                <div className=' pt-[48px] md:pt-[80px] lg:pt-[136px]'>
                        <div className='max-[1536px]:max-w-[1140px] container mx-auto px-3 '>
                                <h2 className=' text-center pb-4 sm:pb-[60px] font-Inter font-bold text-[34px] md:text-[44px] leading-[46px] md:leading-[57px]'>Why Invest in Nvidia Stock</h2>
                                ...
                                <div className=' flex items-center flex-col lg:flex-row justify-center gap-[22px]'>
                                        ...
                                        <button className="text-base w-[146px] h-[48px] font-semibold font-Inter py-3 px-[30px] rounded-[58px] bg-CommonGradient text-white hover:bg-CommonGradientH duration-300">Invest Now </button>
                                </div>
                        </div>
                </div>
        )
